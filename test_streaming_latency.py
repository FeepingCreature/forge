#!/usr/bin/env python3
"""
Test script to measure OpenRouter streaming latency for tool calls.
...
def test_streaming():
    ...
    print(f"Testing streaming latency with {MODEL}")
    print("=" * 60)
    ...
    tool_timings: dict[int, dict] = {}  # tool index -> timing info
